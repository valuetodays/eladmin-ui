      ...
      >
        ...
        <el-table-column prop="timeZoneEnabled" label="timezone状态">
          <template slot-scope="scope">
            <el-tooltip
              :content="'current value: ' + dict.label.switch_status_1_0[scope.row.timeZoneEnabled]"
              placement="top"
            >
              <el-switch
        ...
        <el-table-column prop="httpsEnabled" label="https状态">
          <template slot-scope="scope">
            <el-tooltip
              :content="'current value: ' + dict.label.switch_status_1_0[scope.row.httpsEnabled]"
              placement="top"
            >
              <el-switch
        ...
        <el-table-column
          v-if="checkPer(['admin', 'vtServer:edit', 'vtServer:del'])"
          label="操作"
          width="150px"
          align="center"
        >
...
<script>
  ...
  export default {
    ...
    cruds() {
      return CRUD({
        title: 'VtServerController',
        url: 'api/vtServer/query',
        idField: 'id',
        sort: 'id,desc',
        crudMethod: { ...crudVtServer },
      })
    },
    data() {
      return {
        ...
        rules: {
          ...
          portBindings: [{ required: true, message: '绑定的端口，外网->内网不能为空', trigger: 'blur' }],
          timeZoneEnabled: [{ required: true, message: 'timezone状态不能为空', trigger: 'blur' }],
          domain: [{ required: true, message: '域名不能为空', trigger: 'blur' }],
          httpsEnabled: [{ required: true, message: 'https状态不能为空', trigger: 'blur' }],
