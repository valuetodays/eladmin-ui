        ...
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="区域" prop="region">
            <el-select v-model="form.region" filterable placeholder="请选择">
              <el-option
                v-for="item in dict.stock_region"
                :key="item.id"
                :label="item.label"
                :value="item.value" />
            </el-select>
...
const defaultForm = { id: null, code: null, region: null, name: null, remark: null, createUserId: null, updateUserId: null, createTime: null, updateTime: null }
export default {
  name: 'Stock',
  ...
  dicts: ['stock_region'],
  cruds() {
    return CRUD({ title: '股票信息服务', url: 'api/stock/query', idField: 'id', sort: 'id,desc', crudMethod: { ...crudStock }})
  },
  data() {
    return {
      permission: {
